...
func _on_libreria_interact() -> void:
	$Player.active = false
	if not hablaste_con_libreria:
		$DialogueBox.queue_display_text("hola como va, somos una libreria", DialogueBox.default_talking_speed, "honk")
		$DialogueBox.queue_display_text("no tenemos muchos clientes por aca", DialogueBox.default_talking_speed, "honk")
		...
		$DialogueBox.queue_display_text("te doy lo que quieras si logras que esa wacha se vaya", DialogueBox.default_talking_speed, "honk")
		$DialogueBox.queue_display_text("weno owo", DialogueBox.default_talking_speed)
		hablaste_con_libreria = true
	elif not hablaste_con_orcnella:
		$DialogueBox.queue_display_text("dale wachin, hace que se vaya", DialogueBox.default_talking_speed, "honk")
	else:
		$DialogueBox.queue_display_text("dice la señora que si le das un cigarrillo se va", DialogueBox.default_talking_speed)
		$DialogueBox.queue_display_text("dios que vieja conchuda", DialogueBox.default_talking_speed, "honk")
		$DialogueBox.queue_display_text("mira", DialogueBox.default_talking_speed, "honk")
