...
func _on_animation_player_animation_finished(anim_name: StringName) -> void:
	if anim_name == "Enter":
		...
		pibe.say("oh, qué es esto? :O")
		dios.say("...")
		dios.say("CORTEZA.")
		dios.say("GAZA.")
		dios.say("LUPA")
		pibe.say("... qué se supone que significa esto?")
		dios.say("...")
		dios.say("AFEITAR.")
		dios.say("ITALIANO.")
		dios.say("SOCIEDAD")
		...
		tecnico.say("oh, acá está la máquina")
		tecnico.say("eh qué hacés vos? no podés estar acá")
		pibe.say("vine acá en busca de dios :O")
		pibe.say("pasa que lo escucho hablándome y me dijo que venga acá")
		pibe.say("pero ahora no le encuentro sentido a lo que me dice")
		tecnico.say("aahh ok, ya se qué pasa")
		tecnico.say("acá no está dios pibe, esto es el banco")
		tecnico.say("y eéta es la máquina que genera los alias de las cuentas")
		tecnico.say("pero resulta que la maquina está medio medio")
		tecnico.say("viste cómo andan desfinanciando todo ahora?")
		tecnico.say("qué hijos de puta...")
		tecnico.say("bueno, resulta que ahora la máquina está transmitiendo los aliases que genera en una frecuencia de radio")
		...
		tecnico.say("exacto :)")
		pibe.say("pero qué voy a hacer ahora con mi vida? D:")
